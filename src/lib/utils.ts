 ...
 * defined in globals.css (docs/design-system.md "Type scale") — it only
 * recognizes Tailwind's own default scale (xs/sm/base/lg/...) as the
 * `font-size` group. Without this, a custom size like `text-meta` gets
